package com.greyeg.tajr.callrecorder.activities;
...
import com.greyeg.tajr.callrecorder.app.MixerPaths;
import com.greyeg.tajr.callrecorder.app.Recordings;
import com.greyeg.tajr.callrecorder.app.Storage;
import com.greyeg.tajr.callrecorder.app.SurveysReader;
import com.greyeg.tajr.callrecorder.services.RecordingService;
import com.greyeg.tajr.callrecorder.widgets.MixerPathsPreferenceCompat;
...
public class MainActivityRecording extends AppCompatThemeActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    public final static String TAG = MainActivityRecording.class.getSimpleName();

    public static String SHOW_PROGRESS = MainActivityRecording.class.getCanonicalName() + ".SHOW_PROGRESS";
    public static String SET_PROGRESS = MainActivityRecording.class.getCanonicalName() + ".SET_PROGRESS";
    public static String SHOW_LAST = MainActivityRecording.class.getCanonicalName() + ".SHOW_LAST";
    public static String ENABLE = MainActivityRecording.class.getCanonicalName() + ".ENABLE";
    ...
    public static void startActivity(Context context) {
        Intent i = new Intent(context, MainActivityRecording.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recording_activity_main);
        ...
        fab_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RecordingService.stopButton(MainActivityRecording.this);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.recrding_menu_main, menu);
...
//                startActivity(new Intent(this, SettingsActivity.class));
            ...
            case R.id.action_call:
                ...
                if (item.isChecked() && !Storage.permitted(MainActivityRecording.this, PERMISSIONS, RESULT_CALL)) {
                    resumeCall = item;
                    return true;
                }
            ...
            case R.id.action_about:
                final Runnable survey = new Runnable() {
                    ...
                    public void run() {
                        ...
                        String[] vv = CallApplication.getStrings(MainActivityRecording.this, new Locale("en"), R.array.source_values);
                        String[] ss = CallApplication.getStrings(MainActivityRecording.this, new Locale("en"), R.array.source_text);
                        ...
                        AboutPreferenceCompat.openUrl(MainActivityRecording.this, url);
                    }
                };
                ...
                if (Storage.permitted(this, MUST)) {
                    ...
                    if (!Storage.permitted(this, MUST)) {
                        ...
                        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Storage.showPermissions(MainActivityRecording.this);
                            }
                        });
                        builder.show();
                        resumeCall = null;
