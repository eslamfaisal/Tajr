...
//                Toast.makeText(OldOrderActivity.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
//            }
//        });
//    }
//
...
//                            });
//                        } else {
//                            Toast.makeText(OldOrderActivity.this, "برجاء ادخال المشكلة", Toast.LENGTH_SHORT).show();
//                        }
//                    }
//                });
//
...
//                                            if (response.body() != null) {
//                                                Toast.makeText(OldOrderActivity.this, "تم خصم 5 دقائق", Toast.LENGTH_SHORT).show();
//
...
//                        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(OldOrderActivity.this);
...
//
//                            productsAdapter = new ProductsAdapter(OldOrderActivity.this, order.getMulti_orders(), order.getId(), response.body().getUser_id(), new ProductsAdapter.GetOrderInterface() {
//                                @Override
...
//
//                        finishTheWorkNow();
//                        Toast.makeText(OldOrderActivity.this, R.string.no_orders, Toast.LENGTH_LONG).show();
//                    } else {
...
//                                    OldOrderActivity.class).addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP
...
//                                                    Toast.makeText(OldOrderActivity.this, "تم ارسال رقم  " + callDetails.getPhone() + " المكالمة الفائتة الى السيرفر", Toast.LENGTH_SHORT).show();
//                                                }
//                                            }
//
//                                            @Override
...
//                                        Toast.makeText(OldOrderActivity.this, "تم انهاء الطلب العميل مشغول او غير متاح", Toast.LENGTH_SHORT).show();
//                                        updateOrder(client_busy);
//                                    } else {
//                                        currentCallTimerCount = 0;
//                                        if (currentCallTimer != null)
//                                            currentCallTimer.cancel();
//                                        Toast.makeText(OldOrderActivity.this, "تم انهاء الطلب العميل لم يرد", Toast.LENGTH_SHORT).show();
//                                        updateOrder(client_noanswer);
//                                    }
//
//                                } else {
...
//
//                        if (response.body().getCode().equals("1200")) {
//                            Toast.makeText(OldOrderActivity.this, "تم اضافة المنتج", Toast.LENGTH_SHORT).show();
//                            getFirstOrder();
//                        }
//
//                        dialog.dismiss();
