...
public class RecorderMainActivity extends AppCompatThemeActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    public final static String TAG = RecorderMainActivity.class.getSimpleName();

    public static String SHOW_PROGRESS = RecorderMainActivity.class.getCanonicalName() + ".SHOW_PROGRESS";
    public static String SET_PROGRESS = RecorderMainActivity.class.getCanonicalName() + ".SET_PROGRESS";
    public static String SHOW_LAST = RecorderMainActivity.class.getCanonicalName() + ".SHOW_LAST";
    public static String ENABLE = RecorderMainActivity.class.getCanonicalName() + ".ENABLE";
    ...
    public static void startActivity(Context context) {
        Intent i = new Intent(context, RecorderMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RecordingService.stopButton(RecorderMainActivity.this);
            }
        });
                        ...
                        sw4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                            ...
                            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                                ...
                                if (isChecked && !m.isEnabled())
                                    MixerPathsPreferenceCompat.show(RecorderMainActivity.this);
                                update();
                            }
                        });
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_call:
                ...
                if (item.isChecked() && !Storage.permitted(RecorderMainActivity.this, PERMISSIONS, RESULT_CALL)) {
                    resumeCall = item;
                    return true;
                }
            ...
            case R.id.action_about:
                final Runnable survey = new Runnable() {
                    ...
                    public void run() {
                        ...
                        String[] vv = CallApplication.getStrings(RecorderMainActivity.this, new Locale("en"), R.array.source_values);
                        String[] ss = CallApplication.getStrings(RecorderMainActivity.this, new Locale("en"), R.array.source_text);
                        ...
                        AboutPreferenceCompat.openUrl(RecorderMainActivity.this, url);
                    }
                };
                ...
                if (Storage.permitted(this, MUST)) {
                    ...
                    if (!Storage.permitted(this, MUST)) {
                        ...
                        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Storage.showPermissions(RecorderMainActivity.this);
                            }
                        });
                        builder.show();
                        resumeCall = null;
