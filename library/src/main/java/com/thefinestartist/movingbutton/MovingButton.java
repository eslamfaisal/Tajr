...
public class MovingButton extends Button {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                onPositionChangedListener.moveUp(buttonStat);
    ...
    public static String buttonStat;
...
//            if (337.5 > angle && angle >= 292.5)
//            return ButtonPosition.RIGHT_DOWN;
//        else

            if (292.5 > angle && angle >= 247.5)
            return ButtonPosition.DOWN;
        else
//            if (247.5 > angle && angle >= 202.5)
//            return ButtonPosition.LEFT_DOWN;
//        else
            if (202.5 > angle && angle >= 157.5)
...
//            if (326.25 > angle && angle >= 303.75)
//            return ButtonPosition.RIGHT_DOWN;
//        else
            if (281.25 > angle && angle >= 258.75)
            return ButtonPosition.DOWN;
        else
//            if (236.25 > angle && angle >= 213.75)
//            return ButtonPosition.LEFT_DOWN;
//        else
            if (191.25 > angle && angle >= 168.75)
            return ButtonPosition.LEFT;
        else
//            if (146.25 > angle && angle >= 123.25)
//            return ButtonPosition.LEFT_UP;
//        else
